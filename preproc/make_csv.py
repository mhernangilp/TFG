...
def filter_file(file, all_writer):
    ...
    with open('output_files/' + file + '.csv', 'w', newline='\n') as csvfile:
        ...
        mbox = mailbox.mbox('../resources/raw_data/phishing/' + file + '.mbox')
...
files = ['phishing-2015', 'phishing-2016', 'phishing-2017', 'phishing-2018', 'phishing-2019', 'phishing-2020', 'phishing-2021',
         'phishing-2022', 'phishing-2023', 'phishing-2024']
